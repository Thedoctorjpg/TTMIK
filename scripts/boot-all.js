...
const LANE_BOOTS = ['heal=all', 'heal=1', 'heal=1&sheet=1', 'heal-factor=rei-mercy', 'heal-factor=multiverse-query', 'heal-factor=wiki-meme', 'heal-factor=open-road', 'heal-factor=dream-teleport', 'heal-factor=justice-seek', 'heal-factor=rule-breaker', 'heal-factor=territory-creation', 'heal-factor=item-construction', 'heal-factor=divine-words', 'heal-factor=argon-coin', 'heal-factor=teachings-circe', 'heal-factor=witch-colchis', 'heal-factor=cicada-attune', 'heal-factor=twitter-feed-heal', 'tweet-heal=1', 'sua=1', 'sua=1&sheet=1', 'attune=1&lane=sua', 'asuka=1', 'asuka=1&sheet=1', 'heidi=1', 'heidi=1&sheet=1', 'sven=1', 'sven=1&sheet=1', 'martin=1', 'martin=1&sheet=1', 'ronaldo=1', 'ronaldo=1&sheet=1', 'mbappe=1', 'mbappe=1&sheet=1', 'messi=1', 'messi=1&sheet=1', 'vinicus=1', 'vinicus=1&sheet=1', 'kane=1', 'kane=1&sheet=1', 'kane=1&watch=1', 'neon=1', 'neon=1&sheet=1', 'rei=1', 'rei=1&sheet=1', 'evangelion=1', 'rickmorty=1', 'rickmorty=1&sheet=1', 'rick=1', 'multiverse=1', 'minecraft-meme=1', 'meme=1', 'mika=1', 'mika=1&sheet=1', 'haley=1', 'haley=1&sheet=1', 'vietbonnie=1', 'svsss=1', 'svsss=1&sheet=1', 'webnovel=1', 'heal-factor=b-point-guard', 'solo-leveling=1', 'solo-leveling=1&sheet=1', 'jinwoo=1', 'comic=1', 'heal-factor=e-rank-pause', 'boys-love=1', 'boys-love=1&sheet=1', 'bamboo=1', 'qingbinghe=1', 'heal-factor=slow-burn-boundary', 'sorcerer=1', 'warlock=1', 'monster-slayer=1', 'fijian-indian-warrior=1', 'fiji-warrior=1', 'fiji=1', 'heavypulp=1', 'token=heavypulp', 'doge-aud=1', 'doge=1', 'skill=melbourne-lantern-bard&sheet=1', 'skill=flame-kissed-bard&sheet=1', 'skill=lo3tus&sheet=1', 'skill=rach3l&sheet=1', 'skill=ignan-pilgrim&sheet=1', 'skill=ignan-grounding&sheet=1', 'skill=ignan-dalan&sheet=1', 'attune=1', 'attune=1&lane=kane', 'attune=1&lane=kane&watch=1', 'kane=1&attune=1&watch=1', 'cinema=1', 'beckham=1', 'ignan=1', 'ignan=1&sheet=1', 'fifa=1', 'step=4', 'step=5', 'step=6', 'step=7', 'before-match=1'];
