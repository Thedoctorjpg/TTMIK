...
**Activation phrase:** "The open road is my yes — if you're in my crew, I've got you."
...
- **open-road** — Open road heal — ?mika=1 · OPEN · Ep 7.4 · Boot: `TTMIK.html?heal-factor=open-road`
- **dream-teleport** — Dreamer teleport pivot — ?heal-factor=dream-teleport · OPEN · Ep 7.4 · Boot: `TTMIK.html?heal-factor=dream-teleport`
...
- Skill id: `mika-road-dreamer` in `skills-data.js`
- Set active in **Skills** tab → feeds **Shadowing** phrases
- Linked lessons via **Open linked lessons**

---
*Healed to Hermes agentskills.io format — 2026-06-17*
